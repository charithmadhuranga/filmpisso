...
import 'package:filmpisso/eval/dart/bridge/http.dart';
...
import 'package:filmpisso/eval/dart/bridge/m_provider.dart';
...
import 'package:filmpisso/eval/dart/bridge/source_preference.dart';

class MEvalPlugin extends EvalPlugin {
  @override
  String get identifier => 'package:filmpisso';
  ...
  void configureForRuntime(Runtime runtime) {
    runtime.registerBridgeFunc('package:filmpisso/bridge_lib.dart',
        'MProvider.', $MProvider.$construct,
        isBridge: true);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MChapter.', $MChapter.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MManga.', $MManga.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MPages.', $MPages.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MSource.', $MSource.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MVideo.', $MVideo.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MTrack.', $MTrack.$new);
    runtime.registerBridgeEnumValues(
        'package:filmpisso/bridge_lib.dart', 'MStatus', $MStatus.$values);
    //Filter
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'FilterList.', $FilterList.$new);
    runtime.registerBridgeFunc('package:filmpisso/bridge_lib.dart',
    ...
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'TextFilter.', $TextFilter.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'SortFilter.', $SortFilter.$new);
    runtime.registerBridgeFunc('package:filmpisso/bridge_lib.dart',
        'TriStateFilter.', $TriStateFilter.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'GroupFilter.', $GroupFilter.$new);
    runtime.registerBridgeFunc('package:filmpisso/bridge_lib.dart',
        'CheckBoxFilter.', $CheckBoxFilter.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'SortState.', $SortState.$new);
    runtime.registerBridgeFunc('package:filmpisso/bridge_lib.dart',
    ...
    //DOM HTML
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MElement.', $MElement.$new);
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'MDocument.', $MDocument.$new);
    //HTTP CLIENT
    runtime.registerBridgeFunc(
        'package:filmpisso/bridge_lib.dart', 'Client.', $Client.$new);
  }
}
